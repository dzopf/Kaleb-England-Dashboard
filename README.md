# Kaleb England Dashboard

This is Kaleb England's read-only campaign dashboard. It never writes to the Google Sheet.

## Publish through GitHub

1. Create a new GitHub repository named `kaleb-england-dashboard`.
...
Kaleb's shareable Google Sheet is already configured in this copy. Refresh Dashboard always reads the current Sheet data.
